  ...
  useLayoutEffect(() => {
    ...
    aspectData
      ...
      .forEach((aspect, i) => {
        ...
        if (line1 && line2) {
          // анимация первой половины линии
          lineRenderAnimation({ line: line1, pos: aspect.posA, linePart: aspect.linePart1, delay })

          // анимация второй половины линии
          lineRenderAnimation({ line: line2, pos: aspect.posB, linePart: aspect.linePart2, delay: delay })
          /* line2.points([aspect.posB.x, aspect.posB.y, aspect.posB.x, aspect.posB.y]) */
        }

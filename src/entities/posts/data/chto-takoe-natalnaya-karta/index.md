...
---
::img{src="./gallary/1.jpeg" align="right" width="30%" caption=""}
...
::img{src="./gallary/natal.png" align="left" width="40%" caption="Пример диаграммы натальной карты: круг разделён на 12 домов (Плацидус), по окружности расположены знаки Зодиака, а внутри линиями показаны аспекты между планетами."}
...
::img{src="./gallary/3.jpeg" align="right" width="25%" caption=""}
...
::img{src="./gallary/2.jpeg" align="right" width="25%" caption=""}

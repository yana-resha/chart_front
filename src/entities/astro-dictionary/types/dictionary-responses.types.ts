...
export type IPlanetInSignDictionaryResponse =
  IDictionarySchemaResponseByCategory<DICTIONARY_ITEMS_CATEGORY.PLANET_IN_SIGN>

export type IPlanetInHousesDictionaryResponse =
  IDictionarySchemaResponseByCategory<DICTIONARY_ITEMS_CATEGORY.PLANET_IN_HOUSE>

export type IHouseInSignDictionaryResponse =
  IDictionarySchemaResponseByCategory<DICTIONARY_ITEMS_CATEGORY.HOUSE_IN_SIGN>

export type IAspectDictionaryResponse = IDictionarySchemaResponseByCategory<DICTIONARY_ITEMS_CATEGORY.ASPECT>

export type IConfigurationDictionaryResponse =
...
export interface IBulkItemsDictionaryResponse {
  chart: ASTRO_CHART_VARIABLE
